package com.dev.java.atmDispenserDemo;


import com.dev.java.atmDispenserDemo.controller.AtmDispenController;
import com.dev.java.atmDispenserDemo.db.DatabaseManager;
...
public class AtmControllerTest {
    ...
    @InjectMocks
    AtmDispenController atmDispController;
    ...
    public void subtractBankNumberCorrectly(){
        ...
        int[] result = atmDispController.subtractBankAmt(balanceBanks, usedBanks);
    ...
    public void calculateTotalBalanceCorrectly(){
        ...
        int result = atmDispController.calCurrentTotalAmt(remainingBanks, bankValues);
    ...
    public void findBanksCorrectly(){
        ...
        List<int[]> result = atmDispController.findBanks(180, currentBankAmt, balanceBankAmt, bankValues, 0);
    ...
    public void calculateBankWorkCorrectlyWhenSuccess(){
        ...
        ResponseEntity<ResponseWrapper> response = atmDispController.calculateBank(180);
    ...
    public void calculateBankWorkCorrectlyWhenFail(){
        ...
        ResponseEntity<ResponseWrapper> response = atmDispController.calculateBank(10);
