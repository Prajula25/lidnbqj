package com.dev.java.atmDispenserDemo.controller;

import com.dev.java.atmDispenserDemo.db.DatabaseManager;
import com.dev.java.atmDispenserDemo.model.ResponseWrapper;
import com.dev.java.atmDispenserDemo.util.Constant;
import com.dev.java.atmDispenserDemo.util.BankValidator;
...
@Controller
public class AtmDispenController {

    private final Logger logger = LoggerFactory.getLogger(AtmDispenController.class);
